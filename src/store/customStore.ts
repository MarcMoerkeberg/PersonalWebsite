import type { PiniaCustomStateProperties, StoreActions, StoreGeneric, StoreGetters, StoreState } from 'pinia'
  ...
  type CustomTypes<SS> = ToRefs<StoreState<SS> & StoreGetters<SS> & StoreActions<SS>>
   ...
   */
  export function customStore<SS extends StoreGeneric>(store: SS): CustomTypes<SS> {
